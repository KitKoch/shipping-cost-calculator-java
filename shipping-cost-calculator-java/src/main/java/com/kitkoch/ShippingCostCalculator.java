...
public final class ShippingCostCalculator {
    ...
    public static double weightInputDouble(Scanner input, String msg) throws com.kitkoch.OverMaxWeightException {
        ...
        while(true) {
            ...
            if(input.hasNextDouble()) {
                ...
                if(weight > max) {
                    throw new com.kitkoch.OverMaxWeightException(weight);
                }
    ...
    public static void main(String[] args) {
        ...
        } catch (com.kitkoch.OverMaxWeightException ex) {
            System.out.println("The package cannot be shipped");
        }
    }
}
